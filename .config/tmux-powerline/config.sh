...
# General {
	...
	# The theme to use.
	export TMUX_POWERLINE_THEME="thetheme"
...
# macos_notification_count.sh {
	...
	# sqlite3 -list "/var/folders/7l/pg8d5_712gj08d74l6yttt400000gr/0//com.apple.notificationcenter/db/db" 'select * from app_info'
...
#	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILDIR_INBOX="/Users/ederp/.mail/inbox/new"
#	
#	## mbox
...
#	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILCHECKRC="/Users/ederp/.mailcheckrc"
## }
